class Campanha:
    ...
    def crise(self):
        ...
        self.novo_cpc = self.novo_custo_diario / \
            (self.impressoes_diarias * self.ctr)
        self.novo_lucro_mensal = (
            self.nova_receita_diaria - self.novo_custo_diario) * 30
        return print(f'\n\
                        \nNovo CPC da campanha *{self.nome}* deve ser de {self.novo_cpc:,.2f}\
                        \nO novo lucro mensal deverá ser de R$ {self.novo_lucro_mensal:,.2f}')
